 ...
 * Kozlov Nikita
 */
package org.yeti.server.logic.file;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.yeti.server.logic.AbstractReadQueue;
import org.yeti.utilz.appcontext.ApplicationContextProvider;

import java.io.IOException;

/**
 * Обработчик очереди задач на запись в файл контента. Запуск и остановка данного обработчика происходит в {@link org.yeti.server.admin.FileReadQueueAdmin}.
